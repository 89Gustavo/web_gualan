...
public class DatosColocacion : BasePageModel
{
    [BindProperty]
    ...
    public DatosColocacion(ApiService api) : base(api)
    {
        _api = api;
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (!ValidarArchivo.ValidarNombre(ArchivoCsv.FileName, "DatosColocaciones"))
        {
        ...
        try
        {
            ...
            var endpoint = $"api/csv/cargarColocacionMasiva?usuarioBitacora={usuario}";
