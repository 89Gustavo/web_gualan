...
public class DatosTransacciones : BasePageModel
{
    [BindProperty]
    ...
    public DatosTransacciones(ApiService api) : base(api)
    {
        _api = api;
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (!ValidarArchivo.ValidarNombre(ArchivoCsv.FileName, "DatosTransacciones"))
        {
            TempData["Error"] = "El nombre del archivo debe contener 'DatosTransacciones'";
            return Page();
        }
        ...
        try
        {
            ...
            var endpoint = $"api/csv/cargarDatosTransaccionesMasivoLimpio?usuarioBitacora={usuario}";
