...
public class Captacion : BasePageModel
{
    [BindProperty]
    ...
    public Captacion(ApiService api) : base(api)
    {
        _api = api;
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (!ValidarArchivo.ValidarNombre(ArchivoCsv.FileName, "DatosCaptaciones"))
        {
            TempData["Error"] = "El nombre del archivo debe contener 'DatosColocaciones'";
            return Page();
        }
        ...
        try
        {
            ...
            // var endpoint = $"api/csv/cargarCaptacion?usuarioBitacora={usuario}";
            var endpoint = $"api/csv/cargarCaptacionesMasiva?usuarioBitacora={usuario}";
            ...
            if (ApiResponse != null && ApiResponse.Success)
            {
                ...
                //                      $"Registros insertados: {ApiResponse.RegistrosInsertados}, " +
                //                      $"Errores: {ApiResponse.Errores}";
                //TempData["Success"] = $"Archivo {ApiResponse.Archivo} cargado correctamente. " +
