...
public class DatosTransacInter: BasePageModel
{
    [BindProperty]
    ...
    public DatosTransacInter(ApiService api) : base(api)
    {
        _api = api;
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (!ValidarArchivo.ValidarNombre(ArchivoCsv.FileName, "DatosTransacInter"))
        {
            TempData["Error"] = "El nombre del archivo debe contener 'DatosTransacInter'";
            return Page();
        }
        ...
        try
        {
            ...
            var endpoint = $"api/csv/cargarTransacInterMasivoLimpio?usuarioBitacora={usuario}";
