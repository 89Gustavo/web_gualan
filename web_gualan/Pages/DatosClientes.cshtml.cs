...
public class DatosClientes : BasePageModel
{
    [BindProperty]
    ...
    public DatosClientes(ApiService api) : base(api)
    {
        _api = api;
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (!ValidarArchivo.ValidarNombre(ArchivoCsv.FileName, "DatosClientes"))
        {
            TempData["Error"] = "El nombre del archivo debe contener 'DatosClientes'";
            return Page();
        }
        ...
        try
        {
            ...
            var endpoint = $"api/csv/cargarClientesMasivoLimpio?usuarioBitacora={usuario}";
